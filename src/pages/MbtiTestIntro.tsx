  ...
  return (
    <main className="md:w-[360px] md:h-[812px]">
      ...
      <div className="flex flex-col items-center bg-primary-light w-full h-full">
        ...
        <form className="flex flex-col items-center mt-[120px]" onSubmit={handleSubmit}>
          ...
          <button
            type="submit"
            className="bg-primary-normal hover:opacity-80 mt-10 rounded-lg w-[320px] h-[60px] font-bold text-white"
          >
            시작하기
          </button>
        </form>
